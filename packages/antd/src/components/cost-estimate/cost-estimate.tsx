import { Card, Progress, Space, Typography, Tag, Table } from 'antd';
...
export function CostEstimate({
  ...
  const columns = [
    ...
    { title: 'Tokens', dataIndex: 'tokens', key: 'tokens', align: 'right' as const },
  ...
  return (
    <Card size="small">
      <Space direction="vertical" style={{ width: '100%' }}>
        ...
        {breakdown.model && (
          <Text type="secondary" style={{ fontSize: 12 }}>Model: {breakdown.model}</Text>
        )}
